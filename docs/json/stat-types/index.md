...
description: Both material stats and material traits make use of stat types as part of their JSON definition in Tinkers' Construct. This page covers stat types that exist natively in Tinkers' Construct along with their JSON format since 1.19. 
---
...
Both [material stats](../materials#stats) and [materials traits](../materials#traits) make use of stat types as part of their JSON definition in Tinkers' Construct. This page covers stat types that exist natively in Tinkers' Construct along with their JSON format since 1.19. 
...
Most stat types exist within a group, which can be used to simply adding traits to a specific type of tool.
