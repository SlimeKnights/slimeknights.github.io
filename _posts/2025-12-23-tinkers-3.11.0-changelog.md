...
* If you create a modpack or addon that requires these, we created a quick lowcode mod to reenable this functionality, available on the [release page](https://github.com/SlimeKnights/TinkersConstruct/releases/tag/v3.11.0.148) ([direct link](https://github.com/SlimeKnights/TinkersConstruct/releases/download/v3.11.0.148/Tinkers-Platinum-Tungsten-1.0.0.jar))
